...
public enum SkyWarsGamestate {
	...
	LOBBY(new String[] { "§f", "&fMap:", " &6%map%", "§e", "&fKit:", " &6%kit%" }),

	INGAME(new String[] { "&f", "&fMap:", " &6%map%", "&e", "&fVerbleibend:", " &6%remaining%", "&1", "&fKills:", " &6%kills%" }),

	FINISHED(new String[] { "§f", "&fMap:", " &6%map%", "§e", "&fSpielzeit:", " &6%time%", "§1", "&fKills:", " &6%kills%" });
